...
if(isset($_SESSION['librarianID'])&&$_SESSION['accountType']==="librarian"){
	...
	$librarian_password = $data['librarian_password'];
	...
	if(isset($_POST['btnUpdate'])){
		...
		$librarian_password = $_POST['txtLibrarianPassword'];
	...
	<form action="librarianUpdate.php" method = "POST" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td>New Password</td>
				<td>
					<input type="password" name="txtLibrarianPassword" required value="<?php echo $librarian_password ?>">
				</td>
			</tr>
			<tr>
				<td>Phone Number</td>
