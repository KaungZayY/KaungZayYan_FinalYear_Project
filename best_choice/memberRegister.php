	...
	if(isset($_POST['btnSave'])){
		...
		elseif (mysqli_num_rows($res) > 0){
			...
			elseif (mysqli_num_rows($res) > 0){
				...
				mysqli_stmt_bind_param($insertStmt, 'sssssss', $fileName, $txtMemberName, $txtMemberEmail, $txtMemberPassword, $txtMemberAddress, $txtMemberPhoneNumber,$cboMemberTypeID);
