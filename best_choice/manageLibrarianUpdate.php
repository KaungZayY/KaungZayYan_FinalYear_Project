<?php 
	...
	if (isset($_POST['btnUpdate'])) {
		...
		$librarianPassword=$_POST['txtLibrarianPassword'];
		$librarianAddress=$_POST['txtLibrarianAddress'];
		$librarianPhoneNumber=$_POST['txtLibrarianPhoneNumber'];
		$update="UPDATE librarian SET librarian_name='$librarianName',librarian_email='$librarianEmail', librarian_password='$librarianPassword',librarian_address='$librarianAddress',librarian_phonenumber='$librarianPhoneNumber' WHERE librarian_id='$librarianID'";
	...
	<form action="manageLibrarianUpdate.php" method = "POST" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td>New Password</td>
				<td>
					<input type="password" name="txtLibrarianPassword" required value="<?php echo $librarianPassword ?>">
				</td>
			</tr>
			<tr>
				<td>Phone Number</td>
